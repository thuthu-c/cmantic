...
#line 578 "parser.tab.cc"
  ...
  "FLOAT_LITERAL", "STRING_LITERAL", "A_NAME", "A_LINE", "A_PROGRAM",
  ...
  "A_REF", "A_DEREF", "';'", "':'", "','", "'['", "']'", "'{'", "'}'",
  "'('", "')'", "'<'", "'>'", "'='", "'+'", "'-'", "'*'", "'/'", "'^'",
  "'.'", "A_ASSIGN", "A_LESS_THAN_EQUAL", "A_GREATER_THAN_EQUAL",
  "A_DIFFERENT", "A_EQUAL", "A_OR_LOGIC", "A_AND_LOGIC", "A_RANGE",
  ...
  parser::yytranslate_ (int t) YY_NOEXCEPT
  {
    ...
    translate_table[] =
    {
       ...
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
      46,    47,    53,    51,    41,    52,    56,    54,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,    40,    39,
      48,    50,    49,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,    42,     2,    43,    55,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
